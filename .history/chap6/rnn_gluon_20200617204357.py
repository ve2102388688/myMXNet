...
def train_and_predit_rnn_gluon(model, num_hiddens, vocab_size, ctx, corpus_indices, idx_to_char, char_to_idx, idx_to_char, char_to_idx, idx_to_char, char_to_idx)
