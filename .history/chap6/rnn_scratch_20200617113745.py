...
def train_and_predit_rnn(rnn, get_params, init_rnn_state, num_hiddens, vocab_size, ctx, corpus_indices,
                         idx_to_char, char_to_idx, is_tandom_iter, num_epochs, num_steps, lr, clipping_theta,
